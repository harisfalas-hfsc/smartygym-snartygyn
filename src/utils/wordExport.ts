...
export const smartyGymConceptContent: ContentSection[] = [
  ...
  { type: 'bullet', content: '💎 SmartyGym Premium (€9.99/month) - Monthly access to all workouts, training programs, Smarty Rituals, Check-ins, and every premium feature. Cancel anytime.' },
...
export const wodPhilosophyContent: ContentSection[] = [
  ...
  { type: 'heading', content: 'WORKOUT STRUCTURE WITH FINISHER (MANDATORY)', level: 1 },
  { type: 'paragraph', content: 'Every workout MUST include four sequential parts inside the workout content:' },
  { type: 'bullet', content: '1. WARM-UP - Standard preparation phase' },
  { type: 'bullet', content: '2. MAIN WORKOUT - The core training block that defines the workout FORMAT label' },
  { type: 'bullet', content: '3. FINISHER - A complementary workout block that completes the session' },
  { type: 'bullet', content: '4. COOL DOWN - Recovery and stretching phase' },
  { type: 'heading', content: 'Finisher Rules for Strength and Mobility & Stability', level: 2 },
  { type: 'bullet', content: 'Format: REPS & SETS ONLY (respecting category format rule)' },
  { type: 'bullet', content: 'Load: Reduced compared to main workout' },
  { type: 'bullet', content: 'Reps: Increased compared to main workout' },
  { type: 'bullet', content: 'Purpose: Volume completion without heavy loading' },
  { type: 'bullet', content: 'Example: If main workout uses 4x6 at heavy load, finisher uses 3x12 at lighter load' },
  { type: 'heading', content: 'Finisher Rules for Cardio, Metabolic, Calorie Burning, Challenge', level: 2 },
  { type: 'bullet', content: 'Format: Any allowed format (Circuit, Tabata, EMOM, AMRAP, For Time, single exercise)' },
  { type: 'bullet', content: 'Can differ from main workout format' },
  { type: 'bullet', content: 'Purpose: Metabolic completion or targeted burn' },
  { type: 'bullet', content: 'Example: Main workout is AMRAP, finisher can be Tabata or 100 burpees for time' },
  { type: 'heading', content: 'FORMAT DETERMINATION RULE (CRITICAL)', level: 2 },
  { type: 'paragraph', content: 'The FORMAT label of the entire workout is determined ONLY by the Main Workout. The Finisher format does NOT affect the workout FORMAT classification. Example: Main Workout = AMRAP, Finisher = Tabata → Workout FORMAT = AMRAP' },
  ...
  { type: 'paragraph', content: 'Avoid continually using these words:' },
  { type: 'bullet', content: 'Inferno, Blaze, Fire, Burn, Fury, Storm, Thunder, Power, Beast, Warrior, Elite, Ultimate, Extreme' },
  { type: 'heading', content: 'Category Naming Guidance', level: 2 },
  { type: 'bullet', content: 'Strength → Iron, Forge' },
  { type: 'bullet', content: 'Cardio → Pulse, Rush' },
  { type: 'bullet', content: 'Metabolic → Engine, Drive' },
  { type: 'bullet', content: 'Calorie Burning → Torch, Melt' },
  { type: 'bullet', content: 'Mobility & Stability → Flow, Balance' },
  { type: 'bullet', content: 'Challenge → Gauntlet, Test' },
  { type: 'paragraph', content: 'Use overused words only when a long time (10 days min) has passed without using them.' },
  
  { type: 'heading', content: 'OUTPUT STRUCTURE', level: 1 },
  { type: 'paragraph', content: 'For each workout output:' },
  { type: 'bullet', content: 'Workout Name' },
  { type: 'bullet', content: 'Category' },
  { type: 'bullet', content: 'Difficulty (Stars)' },
  { type: 'bullet', content: 'Duration' },
  { type: 'bullet', content: 'Format' },
  { type: 'bullet', content: 'Equipment Type (Bodyweight or Equipment)' },
  { type: 'bullet', content: 'Workout Structure: Warm-up → Main Workout → Finisher → Cool Down' },
  
  { type: 'heading', content: 'CATEGORY EXAMPLES (REFERENCE ONLY)', level: 1 },
  { type: 'paragraph', content: 'The following examples illustrate proper workout structure for each category. These are references, not templates to copy.' },
  
  { type: 'heading', content: 'STRENGTH (Reps & Sets Only)', level: 2 },
  { type: 'heading', content: 'Example 1 – Bodyweight', level: 3 },
  { type: 'paragraph', content: 'Name: Iron Control | Difficulty: 4 Stars | Duration: 45 min | Format: Reps & Sets' },
  { type: 'paragraph', content: 'Main Workout:' },
  { type: 'bullet', content: 'A1 Push-ups 4×10–12' },
  { type: 'bullet', content: 'A2 Split Squat 4×8/side' },
  { type: 'bullet', content: 'B1 Pike Push-ups 3×8' },
  { type: 'bullet', content: 'B2 Single-leg Glute Bridge 3×10/side' },
  { type: 'bullet', content: 'Rest 90 sec between sets' },
  { type: 'paragraph', content: 'Finisher (Reps & Sets - reduced load, higher reps):' },
  { type: 'bullet', content: 'C1 Diamond Push-ups 3×15' },
  { type: 'bullet', content: 'C2 Bodyweight Squats 3×20' },
  { type: 'heading', content: 'Example 2 – Equipment', level: 3 },
  { type: 'paragraph', content: 'Name: Iron Foundation | Difficulty: 4 Stars | Duration: 45 min | Format: Reps & Sets' },
  { type: 'paragraph', content: 'Main Workout:' },
  { type: 'bullet', content: 'A1 Barbell Back Squat 5×5' },
  { type: 'bullet', content: 'A2 Dumbbell Bench Press 5×6' },
  { type: 'bullet', content: 'B1 Romanian Deadlift 4×6' },
  { type: 'bullet', content: 'B2 Seated Row 4×8' },
  { type: 'bullet', content: 'Rest 2–3 min' },
  { type: 'paragraph', content: 'Finisher (Reps & Sets - reduced load, higher reps):' },
  { type: 'bullet', content: 'C1 Dumbbell Lunges 3×12/side' },
  { type: 'bullet', content: 'C2 Face Pulls 3×15' },
  
  { type: 'heading', content: 'MOBILITY & STABILITY (Reps & Sets Only)', level: 2 },
  { type: 'heading', content: 'Example 1 – Bodyweight', level: 3 },
  { type: 'paragraph', content: 'Name: Flow Balance | Difficulty: 3 Stars | Duration: 30 min' },
  { type: 'paragraph', content: 'Main Workout:' },
  { type: 'bullet', content: 'Dead Bug 3×10' },
  { type: 'bullet', content: 'Single-leg Reach 3×8/side' },
  { type: 'bullet', content: 'Side Plank 3×30 sec' },
  { type: 'bullet', content: "World's Greatest Stretch 3×5/side" },
  { type: 'paragraph', content: 'Finisher (Reps & Sets - light, higher reps):' },
  { type: 'bullet', content: 'Cat-Cow 2×15' },
  { type: 'bullet', content: 'Hip Circles 2×10/side' },
  { type: 'heading', content: 'Example 2 – Equipment', level: 3 },
  { type: 'paragraph', content: 'Name: Flow Control | Difficulty: 3 Stars | Duration: 30 min' },
  { type: 'paragraph', content: 'Main Workout:' },
  { type: 'bullet', content: 'Pallof Press 3×10' },
  { type: 'bullet', content: 'Goblet Cossack Squat 3×6/side' },
  { type: 'bullet', content: 'Stability Ball Stir-the-Pot 3×20 sec' },
  { type: 'bullet', content: 'Band Hip Openers 3×10' },
  { type: 'paragraph', content: 'Finisher (Reps & Sets - light, higher reps):' },
  { type: 'bullet', content: 'Band Pull-aparts 2×20' },
  { type: 'bullet', content: 'Foam Roller Thoracic Extensions 2×10' },
  
  { type: 'heading', content: 'CARDIO', level: 2 },
  { type: 'heading', content: 'Example 1 – Bodyweight', level: 3 },
  { type: 'paragraph', content: 'Name: Pulse Rhythm | Difficulty: 2 Stars | Duration: 30 min | Format: Circuit' },
  { type: 'paragraph', content: 'Main Workout - 5 rounds:' },
  { type: 'bullet', content: 'Jump Rope 60 sec' },
  { type: 'bullet', content: 'Bodyweight Squats 20' },
  { type: 'bullet', content: 'Mountain Climbers 30 sec' },
  { type: 'paragraph', content: 'Finisher - Tabata:' },
  { type: 'bullet', content: 'High Knees 20 sec on / 10 sec off x 8 rounds' },
  { type: 'heading', content: 'Example 2 – Equipment', level: 3 },
  { type: 'paragraph', content: 'Name: Pulse Drive | Difficulty: 2 Stars | Duration: 30 min | Format: EMOM' },
  { type: 'paragraph', content: 'Main Workout - Repeat 10 rounds:' },
  { type: 'bullet', content: 'Min 1: Row 200 m' },
  { type: 'bullet', content: 'Min 2: Bike 12 cal' },
  { type: 'bullet', content: 'Min 3: Rest' },
  { type: 'paragraph', content: 'Finisher - For Time:' },
  { type: 'bullet', content: '500m Row as fast as possible' },
  
  { type: 'heading', content: 'METABOLIC', level: 2 },
  { type: 'heading', content: 'Example 1 – Bodyweight', level: 3 },
  { type: 'paragraph', content: 'Name: Engine Body | Difficulty: 5 Stars | Duration: 40 min | Format: AMRAP' },
  { type: 'paragraph', content: 'Main Workout - 20 min AMRAP:' },
  { type: 'bullet', content: 'Burpees 10' },
  { type: 'bullet', content: 'Jump Lunges 20' },
  { type: 'bullet', content: 'Push-ups 15' },
  { type: 'paragraph', content: 'Finisher - Tabata:' },
  { type: 'bullet', content: 'Mountain Climbers 20 sec on / 10 sec off x 8 rounds' },
  { type: 'heading', content: 'Example 2 – Equipment', level: 3 },
  { type: 'paragraph', content: 'Name: Engine Load | Difficulty: 5 Stars | Duration: 40 min | Format: For Time' },
  { type: 'paragraph', content: 'Main Workout - 5 rounds:' },
  { type: 'bullet', content: 'Kettlebell Swings 25' },
  { type: 'bullet', content: 'Wall Balls 20' },
  { type: 'bullet', content: 'Ski Erg 300 m' },
  { type: 'paragraph', content: 'Finisher - EMOM 5 min:' },
  { type: 'bullet', content: 'Assault Bike 15 cal each minute' },
  
  { type: 'heading', content: 'CALORIE BURNING', level: 2 },
  { type: 'heading', content: 'Example 1 – Bodyweight', level: 3 },
  { type: 'paragraph', content: 'Name: Melt Flow | Difficulty: 1 Star | Duration: 30 min | Format: Circuit' },
  { type: 'paragraph', content: 'Main Workout - 4 rounds:' },
  { type: 'bullet', content: 'Marching Lunges 20' },
  { type: 'bullet', content: 'Step-backs 20' },
  { type: 'bullet', content: 'Low-impact Jacks 40 sec' },
  { type: 'paragraph', content: 'Finisher - 50 Jumping Jacks for time' },
  { type: 'heading', content: 'Example 2 – Equipment', level: 3 },
  { type: 'paragraph', content: 'Name: Melt Machine | Difficulty: 1 Star | Duration: 30 min | Format: Circuit' },
  { type: 'paragraph', content: 'Main Workout:' },
  { type: 'bullet', content: 'Bike 3 min' },
  { type: 'bullet', content: 'Sled Push 20 m' },
  { type: 'bullet', content: 'Farmer Carry 40 m' },
  { type: 'paragraph', content: 'Finisher - Row 500m for time' },
  
  { type: 'heading', content: 'CHALLENGE', level: 2 },
  { type: 'heading', content: 'Example 1 – Bodyweight', level: 3 },
  { type: 'paragraph', content: 'Name: The Test | Difficulty: 6 Stars | Duration: 45 min | Format: Mix' },
  { type: 'paragraph', content: 'Main Workout:' },
  { type: 'paragraph', content: 'Block A – Tabata: Burpees' },
  { type: 'paragraph', content: 'Block B – AMRAP 12 min: Air Squats 30, Push-ups 20' },
  { type: 'paragraph', content: 'Block C – For Time: 800 m Run' },
  { type: 'paragraph', content: 'Finisher - 100 Mountain Climbers for time' },
  { type: 'heading', content: 'Example 2 – Equipment', level: 3 },
  { type: 'paragraph', content: 'Name: The Gauntlet | Difficulty: 6 Stars | Duration: 45 min | Format: Mix' },
  { type: 'paragraph', content: 'Main Workout:' },
  { type: 'paragraph', content: 'Block A – EMOM 10: Row 250 m' },
  { type: 'paragraph', content: 'Block B – AMRAP 15: Wall Balls 20, Kettlebell Snatch 10/side' },
  { type: 'paragraph', content: 'Block C – For Time: Sled Push 100 m' },
  { type: 'paragraph', content: 'Finisher - Tabata: Battle Ropes 20 sec on / 10 sec off x 8 rounds' },
