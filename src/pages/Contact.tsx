      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Get in touch with <span className="whitespace-nowrap">Haris Falas</span> and the Smarty Gym team for online fitness platform support and training inquiries",
