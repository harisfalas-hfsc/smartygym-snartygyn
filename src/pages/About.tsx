          ...
          <CardContent className="p-8 md:p-12 text-center">
            ...
            <p className="text-sm font-semibold text-primary mb-6 max-w-2xl mx-auto">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <Button size="lg" variant="outline" onClick={() => navigate("/workout")} className="gap-2 cta-button">
                  <Target className="w-5 h-5" />
                  Try Free Workouts
                </Button>
                <Button size="lg" variant="outline" onClick={() => navigate("/trainingprogram")} className="gap-2 cta-button">
                  <Calendar className="w-5 h-5" />
                  Try Free Training Programs
                </Button>
                {!isPremium && (
                  <Button size="lg" variant="outline" onClick={() => navigate("/premiumbenefits")} className="gap-2 cta-button">
