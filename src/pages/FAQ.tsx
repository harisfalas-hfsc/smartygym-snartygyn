          ...
          {JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "We don't offer a free trial, but you can explore a selection of free workouts, free training programs, and our fitness tools at no cost before deciding to upgrade. SmartyGym Gold (€9.99/month) and Platinum (€89.99/year) start the day you subscribe and auto-renew until cancelled — you can cancel anytime from your dashboard."
                }
              },
              {
                "@type": "Question",
            ...
            <Card className="border-2 border-primary mb-8">
              ...
              <AccordionItem value="item-7">
                    ...
                    <AccordionContent className="py-2 leading-relaxed">
                      ...
                      <strong>However</strong>, SmartyGym provides you with the <strong>complete ecosystem</strong> to succeed. Every single day, you receive <strong>two fresh workouts</strong> designed by a certified coach, plus access to structured <a href="/trainingprogram" className="text-primary hover:underline font-medium">training programs</a> for every goal and level. Add to that daily <a href="/daily-ritual" className="text-primary hover:underline font-medium">Smarty Rituals</a> for movement and recovery, <a href="/userdashboard?tab=checkins" className="text-primary hover:underline font-medium">Smarty Check-ins</a> for accountability, <a href="/blog" className="text-primary hover:underline font-medium">blog articles</a> with expert knowledge, and a supportive <a href="/community" className="text-primary hover:underline font-medium">community</a> that keeps you motivated.<br/><br/>
                  ...
                  <AccordionItem value="item-7a">
                    ...
                    <AccordionContent className="py-2 leading-relaxed">
                      ...
                      Smarty Ritual is exclusively available for <a href="/smarty-plans" className="text-primary hover:underline font-medium">Premium members</a>.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-8">
                    ...
                    <AccordionContent className="py-2 leading-relaxed">
                      We don't offer a free trial, but you can explore a selection of <strong>free workouts</strong>, <strong>free training programs</strong>, and our <strong>fitness tools</strong> at no cost before deciding to upgrade. SmartyGym <strong>Gold (€9.99/month)</strong> and <strong>Platinum (€89.99/year)</strong> start the day you subscribe and auto-renew until cancelled — you can cancel anytime from your dashboard. You can also buy individual workouts and programs as standalone purchases. Check out our <a href="/smarty-plans" className="text-primary hover:underline font-medium">Smarty Plans</a> to compare access levels and what's included.
                    </AccordionContent>
                  </AccordionItem>
