...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Peloton's All-Access membership costs $44/month and the App One plan is $12.99/month — and neither replaces a real strength program. SmartyGym Premium is €9.99/month and includes everything: workouts, training programs, the WOD, fitness tools, the exercise library and the Daily Smarty Ritual."
  },
  {
  ...
  },
  {
    ...
    a: "Peloton App One is $12.99/month and App+ is $24/month (US pricing, 2026). SmartyGym Premium is €9.99/month with full access to 500+ workouts and all training programs — and you can train without any equipment if you want."
  },
  {
...
const comparisonRows = [
  { feature: "Pricing", smarty: "€9.99 / month (Premium)", peloton: "$12.99–$44 / month" },
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Honest pricing.</strong> €9.99/month. No hardware financing, no upsells.</li>
            </ul>
          </section>
          ...
          <section className="mb-10 text-center bg-muted rounded-lg p-8">
            ...
            <p className="text-muted-foreground mb-6">No bike. No contract. Just real human coaching for €9.99/month. Cancel anytime.</p>
