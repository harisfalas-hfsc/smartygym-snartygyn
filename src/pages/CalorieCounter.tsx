  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://smartygym.com/tools/calorie-counter" />
        ...
        <meta property="og:url" content="https://smartygym.com/tools/calorie-counter" />
      ...
      <SEOEnhancer
        ...
        contentType="tool"
        aiSummary="SmartyGym Calorie Counter (smartygym.com/tools/calorie-counter) is a free online calorie counter powered by the USDA FoodData Central database with 300,000+ foods. Users can search any food — chicken, rice, eggs, banana, pasta, steak, fish, avocado, cheese, bread, and thousands more — enter the quantity in grams, and instantly see calories (kcal), protein, carbs, fat, and fiber. No signup required. The most accurate free calorie counter available online, using the gold-standard USDA nutrition database. Part of SmartyGym's fitness tools suite by Sports Scientist Haris Falas."
        aiKeywords={[
      ...
      <div className="min-h-screen bg-background">
        <div className="container mx-auto max-w-2xl px-4 pb-8">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight uppercase leading-[1.05] mb-2">Calorie Counter</h1>
          </div>
