          ...
          <Card className="p-8 space-y-8">
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-lg text-muted-foreground">
                At <strong>Smarty Gym</strong> (smartygym.com), founded by <strong><a href="/coach-profile" className="text-primary hover:underline whitespace-nowrap">Haris Falas</a></strong>, we value your privacy and are committed to protecting your personal data. 
