  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="smartygym disclaimer, smartygym.com health disclaimer, online fitness platform disclaimer, Haris Falas, fitness training risks, online fitness legal" />
          ...
          <Card className="p-8 space-y-8">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="text-lg text-muted-foreground">
                The information provided on <strong>Smarty Gym</strong> (smartygym.com), founded by <strong><a href="/coach-profile" className="text-primary hover:underline whitespace-nowrap">Haris Falas</a></strong> in Cyprus (the "Website" and mobile applications) is intended 
