...
const BMRCalculator = () => {
  ...
  return (
    <>
      <Helmet>
          <title>Free BMR Calculator | Basal Metabolic Rate | SmartyGym</title>
        <meta name="description" content="Calculate your basal metabolic rate and daily calorie needs with the Mifflin-St Jeor equation." />
      ...
      <div className="container mx-auto max-w-2xl px-4 pb-8">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight uppercase leading-[1.05] mb-2">BMR Calculator</h1>
        </div>
