...
const MacroTrackingCalculator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Macro Calculator | Nutrition Targets | SmartyGym</title>
        <meta name="description" content="Calculate calories, protein, carbs, fats, fiber, water, and meal targets for your fitness goal." />
      ...
      <div className="container mx-auto max-w-2xl px-4 pb-8">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight uppercase leading-[1.05] mb-2">Macro Tracking Calculator</h1>
        </div>
