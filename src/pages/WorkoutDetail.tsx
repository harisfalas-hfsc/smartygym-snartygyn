...
const WorkoutDetail = () => {
  ...
  const workoutData: { [key: string]: Workout[] } = {
    "strength": [
      ...
      { id: "ws002", name: "Bodyweight Foundation Strength", description: "A full-body strength session using tempo, holds, and unilateral control to simulate resistance training", duration: "45 min", equipment: "bodyweight", level: "intermediate", format: "reps & sets", imageUrl: gravityGrindImg, isFree: false },
    ...
    "calorie-burning": [
      ...
      { id: "wc004", name: "Bodyweight Enduro Flow", description: "Continuous-flow cardio bodyweight workout improving endurance and oxygen capacity", duration: "30 min", equipment: "bodyweight", level: "beginner", format: "circuit", imageUrl: cardioBlastImg, isFree: false },
      { id: "wc002", name: "Bodyweight Fat Melt", description: "A HIIT-style circuit emphasizing continuous movement for maximum fat burn", duration: "30 min", equipment: "bodyweight", level: "intermediate", format: "amrap", imageUrl: metabolicBurnImg, isFree: false },
      ...
      { id: "wc001", name: "Calorie Crusher Circuit", description: "A fast-paced circuit that blends resistance and cardio intervals to maximize calorie expenditure and metabolic demand", duration: "45 min", equipment: "equipment", level: "intermediate", format: "circuit", imageUrl: calorieCrusherImg, isFree: false },
      ...
      { id: "wc003", name: "Cardio Power Intervals", description: "Cardio conditioning intervals combining endurance with short strength bursts", duration: "45 min", equipment: "equipment", level: "intermediate", format: "for time", imageUrl: cardioBlastImg, isFree: false },
    ...
    "metabolic": [
      ...
      { id: "wm002", name: "Metabolic Body Blast", description: "Short, explosive bodyweight intervals to maximize metabolic impact", duration: "30 min", equipment: "bodyweight", level: "intermediate", format: "tabata", imageUrl: metaboShockImg, isFree: false },
      ...
      { id: "wm001", name: "Metabolic Destroyer", description: "Metabolic conditioning workout blending strength and cardio elements for post-workout oxygen consumption (EPOC)", duration: "45 min", equipment: "equipment", level: "advanced", format: "for time", imageUrl: metaboInfernoImg, isFree: false },
    ...
    "mobility": [
      ...
      { id: "wmob002", name: "Bodyweight Stability Flow", description: "A gentle movement flow focusing on balance, posture, and joint control", duration: "30 min", equipment: "bodyweight", level: "beginner", format: "circuit", imageUrl: flowForgeImg, isFree: false },
      ...
      { id: "wmob001", name: "Mobility Reset", description: "Mobility and stability session focusing on controlled joint movement and core activation", duration: "45 min", equipment: "equipment", level: "intermediate", format: "circuit", imageUrl: mobilityMasteryImg, isFree: false },
    ...
    "power": [
      ...
      { id: "wp002", name: "Explosive Body Control", description: "Plyometric training session to develop speed and explosive strength", duration: "30 min", equipment: "bodyweight", level: "intermediate", format: "circuit", imageUrl: explosiveEngineImg, isFree: false },
      ...
      { id: "wp001", name: "Power Surge", description: "Explosive power session for athletes focused on speed, coordination, and maximal output", duration: "45 min", equipment: "equipment", level: "advanced", format: "reps & sets", imageUrl: powerSurgeImg, isFree: false },
    ...
    "challenge": [
      ...
      { id: "wch002", name: "HFSC Challenge 2: Bodyweight Inferno", description: "A full-body bodyweight test pushing endurance, coordination, and mindset", duration: "45 min", equipment: "bodyweight", level: "advanced", format: "amrap", imageUrl: ultimateChallengeImg, isFree: false },
      ...
      { id: "wch001", name: "HFSC Challenge 1: The Grinder", description: "The HFSC Grinder is a brutal full-body challenge testing strength, endurance, and willpower", duration: "60 min", equipment: "equipment", level: "advanced", format: "for time", imageUrl: ultimateChallengeImg, isFree: false },
