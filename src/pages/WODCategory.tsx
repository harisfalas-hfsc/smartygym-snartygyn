                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="space-y-2 text-muted-foreground max-w-3xl mx-auto">
                    <p className="text-sm sm:text-base text-center">
                      Every day <span className="text-primary font-semibold">SmartyGym</span> delivers a fresh, expertly designed workout following a strategic periodization cycle. Each day focuses on a different training style: Strength, Calorie Burning, Metabolic, Cardio, Mobility & Stability, and Challenge, rotating continuously for balanced, progressive training. It's like going to the gym and following the workout of the day but you can do it at your local gym, at home, in your office, outdoors, or even while traveling.
                    </p>
                  </div>
                </div>
              </Card>
