...
const WODCategory = () => {
  ...
  // Filter WOD workouts (id starts with 'WOD-')
  const wodWorkouts = allWorkouts.filter(workout => workout.id?.startsWith('WOD-'));

  // Filter and sort workouts with memoization
  const filteredWorkouts = useMemo(() => {
    let filtered = wodWorkouts.filter(workout => {
      // Search filter
      if (debouncedSearch) {
    ...
    return sorted;
  }, [wodWorkouts, debouncedSearch, equipmentFilter, levelFilter, formatFilter, 
            ...
            <div className="container mx-auto max-w-6xl px-4 py-8">
              ...
              <Card className="mb-8 bg-gradient-to-br from-primary/5 via-background to-primary/5 border-2 border-primary/40 shadow-gold">
                <div className="p-4 sm:p-5">
                  <h2 className="text-xl sm:text-2xl font-bold mb-3 text-center">About Workout of the Day</h2>
              ...
              <div className="mb-4">
                <div className="relative">
                  ...
                  <Input
                    type="text"
                    placeholder="Search WOD workouts by name or keyword..."
                    value={searchTerm}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4 px-1">
                <p className="text-xs sm:text-sm text-muted-foreground">
                  Showing {filteredWorkouts.length} of {wodWorkouts.length} WOD workouts
                ...
                {filteredWorkouts.map((workout) => {
                  ...
                  return (
                    <Card
                      ...
                      onClick={() => navigate(`/workout/wod/${workout.id}`)}
                    >
                      {/* NEW Badge */}
                      {isNewWorkout && (
                      ...
                      <div className="relative h-48 w-full overflow-hidden">
                        <img 
                          ...
                          alt={`${workout.name} - Workout of the Day by Haris Falas at SmartyGym.com`}
              ...
              {filteredWorkouts.length === 0 && (
                <Card className="p-8">
                  <p className="text-center text-muted-foreground">
                    No WOD workouts found for this combination. Try different filters.
                  </p>
                </Card>
              )}
            </div>
