...
const Index = () => {
  ...
  return <>
      ...
      <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        {/* Mobile Only: Download App Card - Only shows on mobile when not installed as PWA */}
        {isMobile && !isPwaInstalled && (
          <div className="mt-4 mb-2 px-4">
            <Card className="border-[3px] border-green-500/40 p-4 bg-gradient-to-br from-green-500/5 to-primary/5">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-green-500/10 rounded-xl flex items-center justify-center">
                  <Smartphone className="w-6 h-6 text-green-500" />
                </div>
                <h2 className="text-xl font-bold">
                  Get the <span className="text-primary">SmartyGym</span> App
                </h2>
              </div>
              
              <p className="text-sm text-muted-foreground mb-4">
                Download SmartyGym for instant access to workouts, offline training, and a seamless app experience!
              </p>
