    ...
    <>
      ...
      <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="pt-1 flex justify-center">
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="text-primary drop-shadow-md">Start your fitness journey with SmartyGym</span>
            ...
            <DropdownMenuContent 
              className="w-[calc(100vw-2rem)] sm:w-[480px] lg:w-[520px] p-2 bg-gradient-to-br from-background via-primary/5 to-background border-2 border-primary/20 shadow-2xl backdrop-blur-sm
              ...
              >
                <div className="flex items-center gap-4 w-full">
                  ...
                  <div className="flex-1">
                    <p className="text-base font-bold text-foreground group-hover:text-foreground transition-colors">
                      Workouts
                    </p>
