    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="graphs" className="text-xs sm:text-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Night Check-in</p>
                      <p className="text-sm text-muted-foreground">
                ...
                {todayCheckin?.daily_smarty_score !== null && todayCheckin?.daily_smarty_score !== undefined && (
                  <div className="text-center p-4 rounded-lg bg-muted">
                    ...
                    <p className="text-4xl font-bold">{todayCheckin.daily_smarty_score}</p>
