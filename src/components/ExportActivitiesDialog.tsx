...
import { CalendarIcon, Download, Loader2, CheckCircle2 } from "lucide-react";
import { format, subMonths, startOfMonth } from "date-fns";
import { supabase } from "@/integrations/supabase/client";
import { useToast } from "@/hooks/use-toast";
import { cn } from "@/lib/utils";

interface ExportActivitiesDialogProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export const ExportActivitiesDialog = ({ isOpen, onClose }: ExportActivitiesDialogProps) => {
