...
export const RitualAnnouncementModal = ({ open, onClose }: RitualAnnouncementModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && handleClose()}>
      <DialogContent className="max-w-sm border-2 border-purple-500/60 bg-gradient-to-br from-purple-500/5 via-background to-purple-500/5 shadow-[0_0_40px_rgba(168,85,247,0.15)] p-0 gap-0 animate-scale-in">
        {/* Header */}
