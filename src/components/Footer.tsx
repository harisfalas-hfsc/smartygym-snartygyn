...
export const Footer = () => {
  ...
  return (
    <footer className={`bg-background border-t border-border mt-auto ${isMobile ? 'py-4 px-4' : 'py-8 px-4'}`}>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <a 
                ...
                className="p-1.5 rounded-full border border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-colors" 
                aria-label="Facebook"
              >
