...
export const SisterAppsPopup = () => {
  ...
  return (
    <>
      ...
      >
        <aside
          className="w-[250px] sm:w-[270px] overflow-visible rounded-r-[2rem] border border-l-0 border-primary/25 bg-background/50 backdrop-blur-2xl shadow-[0_20px_70px_hsl(var(--primary)/0.22)] ring-1 ring-primary/10"
        >
