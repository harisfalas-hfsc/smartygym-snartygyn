  ...
  return (
    <>
      ...
      >
        <div className="p-4 sm:p-5">
          ...
          <div className="flex flex-col gap-2.5">
            {others.map((app) => (
              ...
              >
                <div className="w-20 h-20 shrink-0 overflow-hidden bg-white flex items-center justify-center p-3">
                  <img
                    src={app.image}
                    alt={app.name}
                    loading="lazy"
        ...
        {/* Tuck button on the drawer's right edge */}
        <button
          type="button"
      ...
      {/* Thin edge handle to reopen — visible only when drawer is closed */}
      <button
        type="button"
