      ...
      <div className="p-8 md:p-12 max-w-[21cm] mx-auto" style={{ minHeight: '29.7cm', pageBreakAfter: 'always' }}>
        ...
        <div className="flex items-center justify-between mb-8 border-b-4 border-[#29B6D2] pb-6">
          ...
          <div className="text-right">
            <div className="bg-[#1a1a1a] text-white px-4 py-2 rounded-lg">
              <span className="text-[#29B6D2] font-bold">100% Human</span>
        ...
        <div className="bg-gradient-to-r from-[#1a1a1a] to-[#2a2a2a] text-white rounded-xl p-8 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            SmartyGym is your complete online fitness platform designed by Sports Scientist <strong className="text-[#29B6D2]">Haris Falas</strong>. 
        ...
        {/* Features Grid */}
        <h3 className="text-xl font-bold mb-6 text-[#29B6D2] border-b-2 border-[#29B6D2] pb-2">Platform Features</h3>
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-[#29B6D2]">
            <div className="flex items-center gap-2 mb-2">
              <Dumbbell className="h-5 w-5 text-[#29B6D2]" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-[#29B6D2]">
            <div className="flex items-center gap-2 mb-2">
              <Target className="h-5 w-5 text-[#29B6D2]" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-[#29B6D2]">
            <div className="flex items-center gap-2 mb-2">
              <Calculator className="h-5 w-5 text-[#29B6D2]" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-[#29B6D2]">
            <div className="flex items-center gap-2 mb-2">
              <Sparkles className="h-5 w-5 text-[#29B6D2]" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-[#29B6D2]">
            <div className="flex items-center gap-2 mb-2">
              <ClipboardCheck className="h-5 w-5 text-[#29B6D2]" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-[#29B6D2]">
            <div className="flex items-center gap-2 mb-2">
              <BookOpen className="h-5 w-5 text-[#29B6D2]" />
      ...
      <div className="p-8 md:p-12 max-w-[21cm] mx-auto" style={{ minHeight: '29.7cm' }}>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          ...
          <div className="border-2 border-gray-800 rounded-xl p-6 text-center bg-[#1a1a1a] text-white">
            ...
            <p className="text-3xl font-bold mb-4">€9.99<span className="text-sm text-gray-400"> / month</span></p>
            <ul className="text-sm text-left space-y-2">
        ...
        <div className="bg-[#1a1a1a] text-white rounded-xl p-6 mb-8">
          <h3 className="text-xl font-bold mb-4 text-[#29B6D2]">Why Choose SmartyGym?</h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              <Star className="h-5 w-5 text-[#29B6D2] flex-shrink-0 mt-1" />
              <div>
