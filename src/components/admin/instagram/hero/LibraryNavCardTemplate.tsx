...
export const LibraryNavCardTemplate = () => {
  return (
      ...
      <Card className="border-primary border-4 w-full max-w-2xl">
        <CardContent className="flex flex-col items-center justify-center gap-8 p-16">
          ...
          <div className="text-center space-y-4">
            <h3 className="text-6xl font-bold">Exercise Library</h3>
            <p className="text-2xl text-muted-foreground leading-relaxed">
              Comprehensive video library with proper form demonstrations and technique guides
            </p>
          </div>
