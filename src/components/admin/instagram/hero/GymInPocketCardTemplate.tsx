...
export const GymInPocketCardTemplate = () => {
  return (
    <div className="w-[1080px] h-[1080px] bg-background p-12 flex items-center justify-center">
      <Card className="border-primary border-4 w-full max-w-3xl bg-primary/5">
        <CardContent className="flex items-center gap-8 p-12">
          ...
          <div className="flex-1 space-y-3">
            ...
            <p className="text-2xl text-muted-foreground leading-relaxed">
              Professional fitness platform with expert workouts, structured programs, and personalized coaching - accessible worldwide.
            </p>
          </div>
        </CardContent>
