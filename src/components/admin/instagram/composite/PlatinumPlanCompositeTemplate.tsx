...
export const PlatinumPlanCompositeTemplate = () => {
  const features = [
    "Everything in Gold",
    "Priority Support",
    "Early Access",
      ...
      <Card className="border-primary border-4 w-full max-w-3xl">
        ...
        <CardContent className="space-y-5 pb-10">
          ...
          <div className="text-center mt-10 pt-10 border-t-2 border-primary/20">
            <p className="text-5xl font-bold text-primary mb-3">€89.99</p>
            <p className="text-3xl text-muted-foreground mb-6">per year</p>
