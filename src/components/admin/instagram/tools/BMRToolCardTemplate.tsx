...
export const BMRToolCardTemplate = () => {
  return (
      ...
      <Card className="border-primary border-4 w-full max-w-2xl">
        <CardHeader>
          <div className="flex items-center gap-6">
            ...
            <h3 className="text-5xl font-bold">BMR Calculator</h3>
          </div>
        </CardHeader>
        <CardContent>
          <p className="text-3xl text-muted-foreground leading-relaxed">
            Discover your Basal Metabolic Rate to understand your daily calorie needs
          </p>
        </CardContent>
