...
export const PersonalDashboardBenefitTemplate = () => {
  return (
      ...
      <Card className="border-primary border-4 w-full max-w-2xl">
        <CardContent className="flex items-center gap-8 p-12">
          <div className="p-8 rounded-full bg-primary/10">
            <LayoutDashboard className="w-20 h-20 text-primary" />
          </div>
          <div className="flex-1 space-y-3">
            <h3 className="text-5xl font-bold">Personal Dashboard</h3>
            <p className="text-3xl text-muted-foreground">Track your progress</p>
          </div>
        </CardContent>
