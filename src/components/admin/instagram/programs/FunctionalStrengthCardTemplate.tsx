...
export const FunctionalStrengthCardTemplate = () => {
  return (
      ...
      <Card className="border-primary border-4 w-full max-w-2xl">
        <CardContent className="flex items-center gap-8 p-12">
          ...
          <div className="flex-1 space-y-3">
            <h3 className="text-5xl font-bold">Functional Strength</h3>
            <p className="text-3xl text-muted-foreground">Real-world performance</p>
          </div>
        </CardContent>
