      ...
      try {
        ...
        if (aiResponse.ok) {
          ...
          if (aiData.success && aiData.response) {
            ...
            // Send AI response email to customer
            await resend.emails.send({
              from: "SmartyGym <notifications@smartygym.com>",
              to: [email],
              ...
              html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                  ...
                  <div style="padding: 15px; background-color: #f0f0f0; border-radius: 0 0 5px 5px; font-size: 12px; color: #666;">
                    ...
                    <p style="margin: 10px 0 0 0; font-style: italic;">This response was generated by our AI assistant and reviewed for accuracy.</p>
                  </div>
                </div>
              `,
            });
